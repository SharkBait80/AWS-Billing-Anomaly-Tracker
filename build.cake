...
var projects = new []
{
    sourceDir.Path + "src/BillingAnomalyCheckUsageType/src/BillingAnomalyCheckUsageType/BillingAnomalyCheckUsageType.csproj",
    sourceDir.Path + "src/BillingAnomalyMain/src/BillingAnomalyMain/BillingAnomalyMain.csproj",
    sourceDir.Path + "src/BillingAnomalyFinalizer/src/BillingAnomalyFinalizer/BillingAnomalyFinalizer.csproj"
};
